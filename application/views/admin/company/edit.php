            ...
            <div class="col-md-12">
              <div class="box">
                ...
                <div class="box-body">
                  ...
                  <?php echo form_open(base_url('admin/company/edit'), 'class="form-horizontal"');  ?>
                  <div class="form-group">
                    <label for="companyname" class="col-md-12 control-label"><?= trans('company_name') ?></label>

                    <div class="col-md-12">
                      <input type="text" name="companyname" class="form-control" id="companyname" value="<?=$record['name']?>">
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <div class="col-md-12">
                          <input type="number" name="company_phone" class="form-control" id="company_phone" value="<?=$record['tel']?>">
                        </div>
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <div class="col-md-12">
                          <input type="number" name="company_fax" class="form-control" id="company_fax" value="<?=$record['fax']?>">
                        </div>
                      </div>
                    </div>  
                  </div>
                  <div class="row">
                    <div class="col-md-6">  
                      <div class="form-group">
                        ...
                        <div class="col-md-12">
                          <input type="text" name="company_authorized" class="form-control" id="company_authorized" value="<?=$record['authorized']?>">
                        </div>
                      </div>
                    </div>
                    <div class="col-md-6"> 
                      <div class="form-group">
                        ...
                        <div class="col-md-12">
                          <input type="text" name="company_designation" class="form-control" id="company_designation" value="<?=$record['designation']?>">
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-12">
                      <textarea id="main_product" name="main_product" style="width: 100%"><?=$record['product']?></textarea>
                    </div>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-12">
                      <input type="text" name="address" class="form-control" id="address" value="<?=$record['address']?>">
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-md-4">
                  ...
                  <div class="form-group">
                    <div class="col-md-12">
                      <input type="submit" name="submit" value="<?= trans('edit_company') ?>" class="btn btn-primary pull-right">
                    </div>
                  </div>
                  <?php echo form_close(); ?>
                </div>

...
WORKDIR /app
COPY . /app
#RUN ln -s /app/*[^public] /var/www && rm -rf /var/www/html && ln -nsf /app /var/www/html
RUN ln -s /app/ /var/www && rm -rf /var/www/html && ln -nsf /app /var/www/html
RUN chmod -R 750 /app/uploads /app/application/logs && chown -R www-data:www-data /app /app/application
